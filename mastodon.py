        ...
        def wrapper(function, self, *args, **kwargs):
            if not self.version_check_mode == "none":
                ...
                if major > self.mastodon_major:
                    ...
                    raise MastodonVersionError("Version check failed (Need version " + version + ", patch is " + str(
                        self.mastodon_patch) + ")")
...
class Mastodon:
    ...
    __VALID_SCOPES = ['read', 'write', 'follow', 'push', 'admin:read', 'admin:write'] + \
                     __SCOPE_SETS['read'] + __SCOPE_SETS['write'] + __SCOPE_SETS['admin:read'] + __SCOPE_SETS[
                         'admin:write']
    ...
    __DICT_VERSION_STATUS = bigger_version(bigger_version(bigger_version(bigger_version(bigger_version("3.1.0",
                                                                                                       __DICT_VERSION_MEDIA),
                                                                                        __DICT_VERSION_ACCOUNT),
                                                                         __DICT_VERSION_APPLICATION),
                                                          __DICT_VERSION_MENTION), __DICT_VERSION_POLL)
    ...
    ###
    async def __init__(self, client_id=None, client_secret=None, access_token=None,
                       ...
                       version_check_mode="none", session=None, feature_set="mainline"):
        """
        ...
        if session:
            ...
            # self.session = httpx.AsyncClient(backend='asyncio')
        ...
        if mastodon_version == None:
            await self.retrieve_mastodon_version()
        else:
            try:
    ...
    async def retrieve_mastodon_version(self):
        """
        ...
        """
        try:
            instanceResult = await self.__instance()
            version_str = instanceResult["version"]
        except:
        ...
        try:
            ...
            print("mpy instance indexerror: version is %s, domain is %s" % (version_str, self.api_base_url))
            self.mastodon_major = 2
            self.mastodon_minor, self.mastodon_patch = (0, 0)
            return "2.0.0"

    async def verify_minimum_version(self, version_str, cached=False):
        """
    ...
    async def log_in(self, username=None, password=None,
        ...
        try:
            response = await self.__api_request('POST', '/oauth/token', params, do_ratelimiting=False)
        ...
        if not set(scopes) <= set(received_scopes):
            raise MastodonAPIError(
                'Granted scopes "' + " ".join(
                    received_scopes) + '" do not contain all of the requested scopes "' + " ".join(scopes) + '".')
    ...
    async def create_account(self, username, password, email, agreement=False, reason=None, locale="en",
                             scopes=__DEFAULT_SCOPES, to_file=None):
        """
        ...
        try:
            ...
            response = await self.__api_request('POST', '/oauth/token', oauth_params, do_ratelimiting=False)
        ...
        try:
            response = await self.__api_request('POST', '/api/v1/accounts', params, do_ratelimiting=False,
    ...
    async def instance(self):
        ...
        """
        return await self.__instance()

    async def __instance(self):
        """
        Internal, non-version-checking helper that does the same as instance()
        """
        instance = await self.__api_request('GET', '/api/v1/instance/')
        return instance
    ...
    async def instance_activity(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/instance/activity')
    ...
    async def instance_peers(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/instance/peers')
    ...
    async def instance_health(self):
        ...
        """
        return await self.__api_request('GET', '/health', parse=False).decode("utf-8") == "success"

    @api_version("3.0.0", "3.0.0", "3.0.0")
    async def instance_nodeinfo(self, schema="http://nodeinfo.diaspora.software/ns/schema/2.0"):
        """
        ...
        parameter.
        """
        links = await self.__api_request('GET', '/.well-known/nodeinfo')["links"]
        ...
        try:
            return await self.__api_request('GET', schema_url, base_url_override="")
        except MastodonNotFoundError:
            parse = urlparse(schema_url)
            return await self.__api_request('GET', parse.path + parse.params + parse.query + parse.fragment)

    ###
    # Reading data: Timelines
    ##
    @api_version("1.0.0", "2.6.0", __DICT_VERSION_STATUS)
    async def timeline(self, timeline="home", max_id=None, min_id=None, since_id=None, limit=None):
        """
        ...
        return await self.__api_request('GET', url, params)
    ...
    @api_version("1.0.0", "2.6.0", __DICT_VERSION_STATUS)
    async def timeline_public(self, max_id=None, min_id=None, since_id=None, limit=None, only_media=False):
        """
    ...
    @api_version("1.0.0", "2.6.0", __DICT_VERSION_STATUS)
    async def timeline_hashtag(self, hashtag, local=False, max_id=None, min_id=None, since_id=None, limit=None,
                               only_media=False):
        """
    ...
    async def conversations(self, max_id=None, min_id=None, since_id=None, limit=None):
        """
        ...
        return await self.__api_request('GET', "/api/v1/conversations/", params)
    ...
    async def status_card(self, id):
        ...
        """
        if await self.verify_minimum_version("3.0.0"):
    ...
    async def status_reblogged_by(self, id):
        """
    ...
    @api_version("1.0.0", "2.1.0", __DICT_VERSION_ACCOUNT)
    async def status_favourited_by(self, id):
        """
    ...
    async def scheduled_statuses(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/scheduled_statuses')

    @api_version("2.7.0", "2.7.0", __DICT_VERSION_SCHEDULED_STATUS)
    async def scheduled_status(self, id):
        """
    ...
    async def notifications(self, id=None, account_id=None, max_id=None, min_id=None, since_id=None, limit=None,
                      mentions_only=None):
        """
        ...
        if id is None:
            ...
            return await self.__api_request('GET', '/api/v1/notifications', params)
        else:
            id = self.__unpack_id(id)
    ...
    async def account_statuses(self, id, only_media=False, pinned=False, exclude_replies=False, max_id=None,
                               min_id=None, since_id=None, limit=None):
        """
    ...
    async def account_following(self, id, max_id=None, min_id=None, since_id=None, limit=None):
        """
    ...
    @api_version("1.0.0", "2.6.0", __DICT_VERSION_ACCOUNT)
    async def account_followers(self, id, max_id=None, min_id=None, since_id=None, limit=None):
        """
    ...
    async def account_relationships(self, id):
        """
        ...
        id = self.__unpack_id(id)
        params = self.__generate_params(locals())
        return await self.__api_request('GET', '/api/v1/accounts/relationships',
                                        params)

    @api_version("1.0.0", "2.3.0", __DICT_VERSION_ACCOUNT)
    async def account_search(self, q, limit=None, following=False):
        """
        ...
        return await self.__api_request('GET', '/api/v1/accounts/search', params)

    @api_version("2.1.0", "2.1.0", __DICT_VERSION_LIST)
    async def account_lists(self, id):
        """
    ...
    async def featured_tags(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/featured_tags')

    @api_version("3.0.0", "3.0.0", __DICT_VERSION_HASHTAG)
    async def featured_tag_suggestions(self):
        """
        Returns the logged-in users 10 most commonly hashtags.

        Returns a list of `hashtag dicts`_.
        """
        return await self.__api_request('GET', '/api/v1/featured_tags/suggestions')
    ...
    async def filters(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/filters')

    @api_version("2.4.3", "2.4.3", __DICT_VERSION_FILTER)
    async def filter(self, id):
        """
    ...
    async def suggestions(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/suggestions')
    ...
    async def directory(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/directory')

    ###
    # Reading data: Endorsements
    ###
    @api_version("2.5.0", "2.5.0", __DICT_VERSION_ACCOUNT)
    async def endorsements(self):
        """
        ...
        """
        return await self.__api_request('GET', '/api/v1/endorsements')
    ...
    async def search_v1(self, q, resolve=False):
        """
        ...
        if resolve == False:
            del params['resolve']
        return await self.__api_request('GET', '/api/v1/search', params)

    @api_version("2.4.1", "2.8.0", __DICT_VERSION_SEARCHRESULT)
    async def search_v2(self, q, resolve=True, result_type=None, account_id=None, offset=None, min_id=None, max_id=None,
                        exclude_unreviewed=True):
        """
        ...
        return await self.__api_request('GET', '/api/v2/search', params)

    ###
    # Reading data: Trends
    ###
    @api_version("2.4.3", "3.0.0", __DICT_VERSION_HASHTAG)
    async def trends(self, limit=None):
        """
        ...
        """
        params = self.__generate_params(locals())
        return await self.__api_request('GET', '/api/v1/trends', params)
    ...
    async def lists(self):
        ...
        Returns a list of `list dicts`_.
        """
        return await self.__api_request('GET', '/api/v1/lists')

    @api_version("2.1.0", "2.1.0", __DICT_VERSION_LIST)
    async def list(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('GET', '/api/v1/lists/{0}'.format(id))

    @api_version("2.1.0", "2.6.0", __DICT_VERSION_ACCOUNT)
    async def list_accounts(self, id, max_id=None, min_id=None, since_id=None, limit=None):
        """
        ...
        params = self.__generate_params(locals(), ['id'])
        return await self.__api_request('GET', '/api/v1/lists/{0}/accounts'.format(id))

    ###
    # Reading data: Mutes and Blocks
    ###
    @api_version("1.1.0", "2.6.0", __DICT_VERSION_ACCOUNT)
    async def mutes(self, max_id=None, min_id=None, since_id=None, limit=None):
        """
        ...
        params = self.__generate_params(locals())
        return await self.__api_request('GET', '/api/v1/mutes', params)

    @api_version("1.0.0", "2.6.0", __DICT_VERSION_ACCOUNT)
    async def blocks(self, max_id=None, min_id=None, since_id=None, limit=None):
        """
        ...
        params = self.__generate_params(locals())
        return await self.__api_request('GET', '/api/v1/blocks', params)
    ...
    async def reports(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/reports')

    ###
    # Reading data: Favourites
    ###
    @api_version("1.0.0", "2.6.0", __DICT_VERSION_STATUS)
    async def favourites(self, max_id=None, min_id=None, since_id=None, limit=None):
        """
        ...
        params = self.__generate_params(locals())
        return await self.__api_request('GET', '/api/v1/favourites', params)

    ###
    # Reading data: Follow requests
    ###
    @api_version("1.0.0", "2.6.0", __DICT_VERSION_ACCOUNT)
    async def follow_requests(self, max_id=None, min_id=None, since_id=None, limit=None):
        """
        ...
        params = self.__generate_params(locals())
        return await self.__api_request('GET', '/api/v1/follow_requests', params)

    ###
    # Reading data: Domain blocks
    ###
    @api_version("1.4.0", "2.6.0", "1.4.0")
    async def domain_blocks(self, max_id=None, min_id=None, since_id=None, limit=None):
        """
        ...
        params = self.__generate_params(locals())
        return await self.__api_request('GET', '/api/v1/domain_blocks', params)
    ...
    async def custom_emojis(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/custom_emojis')

    ###
    # Reading data: Apps
    ###
    @api_version("2.0.0", "2.7.2", __DICT_VERSION_APPLICATION)
    async def app_verify_credentials(self):
        """
        ...
        """
        return await self.__api_request('GET', '/api/v1/apps/verify_credentials')

    ###
    # Reading data: Webpush subscriptions
    ###
    @api_version("2.4.0", "2.4.0", __DICT_VERSION_PUSH)
    async def push_subscription(self):
        """
        ...
        """
        return await self.__api_request('GET', '/api/v1/push/subscription')
    ...
    async def preferences(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/preferences')
    ...
    async def announcements(self):
        ...
        """
        return await self.__api_request('GET', '/api/v1/announcements')

    ##
    # Reading data: Read markers
    ##
    @api_version("3.0.0", "3.0.0", __DICT_VERSION_MARKER)
    async def markers_get(self, timeline=["home"]):
        """
        ...
        return await self.__api_request('GET', '/api/v1/markers', params)
    ...
    async def bookmarks(self):
        ...
        Returns a list of `toot dicts`_.
        """
        return await self.__api_request('GET', '/api/v1/bookmarks')

    ###
    # Writing data: Statuses
    ###
    @api_version("1.0.0", "2.8.0", __DICT_VERSION_STATUS)
    async def status_post(self, status, in_reply_to_id=None, media_ids=None,
        ...
        **Specific to `fedibird` feature set:**: The `quote_id` parameter is
        ...
        return await self.__api_request('POST', '/api/v1/statuses', params, headers=headers, use_json=use_json)
    ...
    async def status_delete(self, id):
        """
        Delete a status
        ...
        id = self.__unpack_id(id)
        url = '/api/v1/statuses/{0}'.format(str(id))
        return await self.__api_request('DELETE', url)

    @api_version("1.0.0", "2.0.0", __DICT_VERSION_STATUS)
    async def status_reblog(self, id, visibility=None):
        """
        ...
        return await self.__api_request('POST', url, params)

    @api_version("1.0.0", "2.0.0", __DICT_VERSION_STATUS)
    async def status_unreblog(self, id):
        """
        Un-reblog a status.
    ...
    @api_version("1.0.0", "2.0.0", __DICT_VERSION_STATUS)
    async def status_favourite(self, id):
        """
        Favourite a status.
    ...
    @api_version("1.0.0", "2.0.0", __DICT_VERSION_STATUS)
    async def status_unfavourite(self, id):
        """
    ...
    @api_version("1.4.0", "2.0.0", __DICT_VERSION_STATUS)
    async def status_unmute(self, id):
        """
    ...
    @api_version("2.1.0", "2.1.0", __DICT_VERSION_STATUS)
    async def status_unpin(self, id):
        """
    ...
    @api_version("3.1.0", "3.1.0", __DICT_VERSION_STATUS)
    async def status_bookmark(self, id):
        """
    ...
    @api_version("3.1.0", "3.1.0", __DICT_VERSION_STATUS)
    async def status_unbookmark(self, id):
        """
    ...
    ###
    @api_version("2.7.0", "2.7.0", __DICT_VERSION_SCHEDULED_STATUS)
    async def scheduled_status_update(self, id, scheduled_at):
        """
        ...
        params = self.__generate_params(locals(), ['id'])
        url = '/api/v1/scheduled_statuses/{0}'.format(str(id))
        return await self.__api_request('PUT', url, params)

    @api_version("2.7.0", "2.7.0", "2.7.0")
    async def scheduled_status_delete(self, id):
        """
    ...
    ###
    @api_version("2.8.0", "2.8.0", __DICT_VERSION_POLL)
    async def poll_vote(self, id, choices):
        """
        ...
        await self.__api_request('POST', url, params)
    ...
    async def notifications_clear(self):
        ...
        """
        await self.__api_request('POST', '/api/v1/notifications/clear')

    @api_version("1.3.0", "2.9.2", "2.9.2")
    async def notifications_dismiss(self, id):
        """
        ...
        if self.verify_minimum_version("2.9.2"):
            ...
            await self.__api_request('POST', url)
        else:
            params = self.__generate_params(locals())
            await self.__api_request('POST', '/api/v1/notifications/dismiss', params)

    ###
    # Writing data: Conversations
    ###
    @api_version("2.6.0", "2.6.0", __DICT_VERSION_CONVERSATION)
    async def conversations_read(self, id):
        """
    ...
    async def account_follow(self, id, reblogs=True):
        """
        Follow a user.
    ...
    async def follows(self, uri):
        ...
        """
        params = self.__generate_params(locals())
        return await self.__api_request('POST', '/api/v1/follows', params)

    @api_version("1.0.0", "1.4.0", __DICT_VERSION_RELATIONSHIP)
    async def account_unfollow(self, id):
        """
        Unfollow a user.
    ...
    @api_version("1.0.0", "1.4.0", __DICT_VERSION_RELATIONSHIP)
    async def account_block(self, id):
        """
        Block a user.
    ...
    @api_version("1.0.0", "1.4.0", __DICT_VERSION_RELATIONSHIP)
    async def account_unblock(self, id):
        """
        Unblock a user.
    ...
    async def account_mute(self, id, notifications=True):
        """
        Mute a user.
    ...
    async def account_unmute(self, id):
        """
        Unmute a user.
    ...
    async def account_update_credentials(self, display_name=None, note=None,
        ...
        params = self.__generate_params(params_initial)
        return await self.__api_request('PATCH', '/api/v1/accounts/update_credentials', params, files=files)

    @api_version("2.5.0", "2.5.0", __DICT_VERSION_RELATIONSHIP)
    async def account_pin(self, id):
        """
        Pin / endorse a user.
    ...
    @api_version("2.5.0", "2.5.0", __DICT_VERSION_RELATIONSHIP)
    async def account_unpin(self, id):
        """
    ...
    ###
    @api_version("3.0.0", "3.0.0", __DICT_VERSION_FEATURED_TAG)
    async def featured_tag_create(self, name):
        """
        ...
        """
        params = self.__generate_params(locals())
        return await self.__api_request('POST', '/api/v1/featured_tags', params)

    @api_version("3.0.0", "3.0.0", __DICT_VERSION_FEATURED_TAG)
    async def featured_tag_delete(self, id):
        """
        Deletes one of the logged-in users featured hashtags.
        """
        id = self.__unpack_id(id)
        url = '/api/v1/featured_tags/{0}'.format(str(id))
        await self.__api_request('DELETE', url)

    ###
    # Writing data: Keyword filters
    ###
    @api_version("2.4.3", "2.4.3", __DICT_VERSION_FILTER)
    async def filter_create(self, phrase, context, irreversible=False, whole_word=True, expires_in=None):
        """
        ...
        return await self.__api_request('POST', '/api/v1/filters', params)

    @api_version("2.4.3", "2.4.3", __DICT_VERSION_FILTER)
    async def filter_update(self, id, phrase=None, context=None, irreversible=None, whole_word=None, expires_in=None):
        """
    ...
    async def filter_delete(self, id):
        """
    ...
    ###
    @api_version("2.4.3", "2.4.3", __DICT_VERSION_ACCOUNT)
    async def suggestion_delete(self, account_id):
        """
    ...
    ###
    @api_version("2.1.0", "2.1.0", __DICT_VERSION_LIST)
    async def list_create(self, title):
        """
        ...
        """
        params = self.__generate_params(locals())
        return await self.__api_request('POST', '/api/v1/lists', params)

    @api_version("2.1.0", "2.1.0", __DICT_VERSION_LIST)
    async def list_update(self, id, title):
        """
        ...
        id = self.__unpack_id(id)
        params = self.__generate_params(locals(), ['id'])
        return await self.__api_request('PUT', '/api/v1/lists/{0}'.format(id), params)

    @api_version("2.1.0", "2.1.0", "2.1.0")
    async def list_delete(self, id):
        """
        Delete a list.
        """
        id = self.__unpack_id(id)
        await self.__api_request('DELETE', '/api/v1/lists/{0}'.format(id))

    @api_version("2.1.0", "2.1.0", "2.1.0")
    async def list_accounts_add(self, id, account_ids):
        """
        ...
        params = self.__generate_params(locals(), ['id'])
        await self.__api_request('POST', '/api/v1/lists/{0}/accounts'.format(id), params)

    @api_version("2.1.0", "2.1.0", "2.1.0")
    async def list_accounts_delete(self, id, account_ids):
        """
        ...
        params = self.__generate_params(locals(), ['id'])
        await self.__api_request('DELETE', '/api/v1/lists/{0}/accounts'.format(id), params)

    ###
    # Writing data: Reports
    ###
    @api_version("1.1.0", "2.5.0", __DICT_VERSION_REPORT)
    async def report(self, account_id, status_ids=None, comment=None, forward=False):
        """
        ...
        params = self.__generate_params(params_initial)
        return await self.__api_request('POST', '/api/v1/reports/', params)

    ###
    # Writing data: Follow requests
    ###
    @api_version("1.0.0", "3.0.0", __DICT_VERSION_RELATIONSHIP)
    async def follow_request_authorize(self, id):
        """
    ...
    @api_version("1.0.0", "3.0.0", __DICT_VERSION_RELATIONSHIP)
    async def follow_request_reject(self, id):
        """
    ...
    async def media_post(self, media_file, mime_type=None, description=None, focus=None):
        """
    ...
    async def media_update(self, id, description=None, focus=None):
        ...
        params = self.__generate_params(locals(), ['id'])
        return await self.__api_request('PUT', '/api/v1/media/{0}'.format(str(id)), params)

    ###
    # Writing data: Domain blocks
    ###
    @api_version("1.4.0", "1.4.0", "1.4.0")
    async def domain_block(self, domain=None):
        """
        Add a block for all statuses originating from the specified domain for the logged-in user.
        """
        params = self.__generate_params(locals())
        await self.__api_request('POST', '/api/v1/domain_blocks', params)

    @api_version("1.4.0", "1.4.0", "1.4.0")
    async def domain_unblock(self, domain=None):
        """
        Remove a domain block for the logged-in user.
        """
        params = self.__generate_params(locals())
        await self.__api_request('DELETE', '/api/v1/domain_blocks', params)

    ##
    # Writing data: Read markers
    ##
    @api_version("3.0.0", "3.0.0", __DICT_VERSION_MARKER)
    async def markers_set(self, timelines, last_read_ids):
        """
        ...
        return await self.__api_request('POST', '/api/v1/markers', params, use_json=True)

    ###
    # Writing data: Push subscriptions
    ###
    @api_version("2.4.0", "2.4.0", __DICT_VERSION_PUSH)
    async def push_subscription_set(self, endpoint, encrypt_params, follow_events=None,
        ...
        return await self.__api_request('POST', '/api/v1/push/subscription', params)

    @api_version("2.4.0", "2.4.0", __DICT_VERSION_PUSH)
    async def push_subscription_update(self, follow_events=None,
                                       favourite_events=None, reblog_events=None,
                                       mention_events=None, poll_events=None,
                                       follow_request_events=None):
        """
        ...
        return await self.__api_request('PUT', '/api/v1/push/subscription', params)

    @api_version("2.4.0", "2.4.0", "2.4.0")
    async def push_subscription_delete(self):
        """
    ...
    async def announcement_dismiss(self, id):
        """
    ...
    @api_version("3.1.0", "3.1.0", "3.1.0")
    async def announcement_reaction_create(self, id, reaction):
        """
        ...
        await self.__api_request('PUT', url)

    @api_version("3.1.0", "3.1.0", "3.1.0")
    async def announcement_reaction_delete(self, id, reaction):
        """
    ...
    async def admin_accounts(self, remote=False, by_domain=None, status='active', username=None, display_name=None,
                             email=None, ip=None, staff_only=False, max_id=None, min_id=None, since_id=None,
                             limit=None):
        """
        ...
        * Set `staff_only` to True to only get staff accounts (this only works on local accounts).
        ...
        return await self.__api_request('GET', '/api/v1/admin/accounts', params)

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_ADMIN_ACCOUNT)
    async def admin_account(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('GET', '/api/v1/admin/accounts/{0}'.format(id))

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_ADMIN_ACCOUNT)
    async def admin_account_enable(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('POST', '/api/v1/admin/accounts/{0}/enable'.format(id))

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_ADMIN_ACCOUNT)
    async def admin_account_approve(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('POST', '/api/v1/admin/accounts/{0}/approve'.format(id))

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_ADMIN_ACCOUNT)
    async def admin_account_reject(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('POST', '/api/v1/admin/accounts/{0}/reject'.format(id))

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_ADMIN_ACCOUNT)
    async def admin_account_unsilence(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('POST', '/api/v1/admin/accounts/{0}/unsilence'.format(id))

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_ADMIN_ACCOUNT)
    async def admin_account_unsuspend(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('POST', '/api/v1/admin/accounts/{0}/unsuspend'.format(id))

    @api_version("2.9.1", "2.9.1", "2.9.1")
    async def admin_account_moderate(self, id, action=None, report_id=None, warning_preset_id=None, text=None,
    ...
    async def admin_reports(self, resolved=False, account_id=None, target_account_id=None, max_id=None, min_id=None,
                            since_id=None, limit=None):
        """
        ...
        params = self.__generate_params(locals())
        return await self.__api_request('GET', '/api/v1/admin/reports', params)

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_REPORT)
    async def admin_report(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('GET', '/api/v1/admin/reports/{0}'.format(id))

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_REPORT)
    async def admin_report_assign(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('POST', '/api/v1/admin/reports/{0}/assign_to_self'.format(id))

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_REPORT)
    async def admin_report_unassign(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('POST', '/api/v1/admin/reports/{0}/unassign'.format(id))

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_REPORT)
    async def admin_report_reopen(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('POST', '/api/v1/admin/reports/{0}/reopen'.format(id))

    @api_version("2.9.1", "2.9.1", __DICT_VERSION_REPORT)
    async def admin_report_resolve(self, id):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__api_request('POST', '/api/v1/admin/reports/{0}/resolve'.format(id))
    ...
    def push_subscription_generate_keys(self):
        ...
        if bigger_version(crypto_ver, "2.5.0") == crypto_ver:
            push_key_pub = push_key_pair.public_key().public_bytes(serialization.Encoding.X962,
    ...
    # Pagination
    ###
    async def fetch_next(self, previous_page):
        """
        ...
        return await self.__api_request(method, endpoint, params)

    async def fetch_previous(self, next_page):
        """
    ...
    async def stream_user(self, listener, run_async=False, timeout=__DEFAULT_STREAM_TIMEOUT, reconnect_async=False,
                          reconnect_async_wait_sec=__DEFAULT_STREAM_RECONNECT_WAIT_SEC):
        """
        Streams events that are relevant to the authorized user, i.e. home
        timeline and notifications.
        """
        return await self.__stream('/api/v1/streaming/user', listener, run_async=run_async, timeout=timeout,
                                   reconnect_async=reconnect_async, reconnect_async_wait_sec=reconnect_async_wait_sec)

    @api_version("1.1.0", "1.4.2", __DICT_VERSION_STATUS)
    async def stream_public(self, listener, run_async=False, timeout=__DEFAULT_STREAM_TIMEOUT, reconnect_async=False,
                            reconnect_async_wait_sec=__DEFAULT_STREAM_RECONNECT_WAIT_SEC):
        """
        Streams public events.
        """
        return await self.__stream('/api/v1/streaming/public', listener, run_async=run_async, timeout=timeout,
                                   reconnect_async=reconnect_async, reconnect_async_wait_sec=reconnect_async_wait_sec)

    @api_version("1.1.0", "1.4.2", __DICT_VERSION_STATUS)
    async def stream_local(self, listener, run_async=False, timeout=__DEFAULT_STREAM_TIMEOUT, reconnect_async=False,
                           reconnect_async_wait_sec=__DEFAULT_STREAM_RECONNECT_WAIT_SEC):
        """
        Streams local public events.
        """
        return await self.__stream('/api/v1/streaming/public/local', listener, run_async=run_async, timeout=timeout,
                                   reconnect_async=reconnect_async, reconnect_async_wait_sec=reconnect_async_wait_sec)

    @api_version("1.1.0", "1.4.2", __DICT_VERSION_STATUS)
    async def stream_hashtag(self, tag, listener, local=False, run_async=False, timeout=__DEFAULT_STREAM_TIMEOUT,
                             reconnect_async=False, reconnect_async_wait_sec=__DEFAULT_STREAM_RECONNECT_WAIT_SEC):
        """
        ...
        if local:
            base += '/local'
        return await self.__stream("{}?tag={}".format(base, tag), listener, run_async=run_async, timeout=timeout,
                                   reconnect_async=reconnect_async, reconnect_async_wait_sec=reconnect_async_wait_sec)

    @api_version("2.1.0", "2.1.0", __DICT_VERSION_STATUS)
    async def stream_list(self, id, listener, run_async=False, timeout=__DEFAULT_STREAM_TIMEOUT, reconnect_async=False,
                          reconnect_async_wait_sec=__DEFAULT_STREAM_RECONNECT_WAIT_SEC):
        """
        ...
        """
        id = self.__unpack_id(id)
        return await self.__stream("/api/v1/streaming/list?list={}".format(id), listener, run_async=run_async,
                                   timeout=timeout, reconnect_async=reconnect_async,
                                   reconnect_async_wait_sec=reconnect_async_wait_sec)

    @api_version("2.6.0", "2.6.0", __DICT_VERSION_STATUS)
    async def stream_direct(self, listener, run_async=False, timeout=__DEFAULT_STREAM_TIMEOUT, reconnect_async=False,
                            reconnect_async_wait_sec=__DEFAULT_STREAM_RECONNECT_WAIT_SEC):
        """
        Streams direct message events for the logged-in user, as conversation events.
        """
        return await self.__stream('/api/v1/streaming/direct', listener, run_async=run_async, timeout=timeout,
                                   reconnect_async=reconnect_async, reconnect_async_wait_sec=reconnect_async_wait_sec)

    @api_version("2.5.0", "2.5.0", "2.5.0")
    async def stream_healthy(self):
        """
        Returns without True if streaming API is okay, False or raises an error otherwise.
        """
        api_okay = await self.__api_request('GET', '/api/v1/streaming/health',
                                            base_url_override=self.__get_streaming_base(), parse=False)
        if api_okay == b'OK':
            return True
        return False
    ...
    def __json_strnum_to_bignum(json_object):
        ...
        """
        for key in (
        'id', 'week', 'in_reply_to_id', 'in_reply_to_account_id', 'logins', 'registrations', 'statuses', 'day',
        'last_read_id'):
            if (key in json_object and isinstance(json_object[key], six.text_type)):
                try:
    ...
    async def __api_request(self, method, endpoint, params={}, files={}, headers={}, access_token_override=None,
                            base_url_override=None, do_ratelimiting=True, use_json=False, parse=True):
        """
        ...
        while not request_complete:
            ...
            try:
                ...
                response_object = await self.session.request(method, base_url + endpoint, **kwargs)
            except Exception as e:
                raise MastodonNetworkError("Could not complete request: %s" % e)
            ...
            if isinstance(response, list) and \
                ...
                for url in tmp_urls:
                    ...
                    if url['rel'] == 'prev':
                        ...
                        # New hotness (post-2.6.0): min_id pagination
    ...
    async def __get_streaming_base(self):
        ...
        print("Streaming URL is %s" % url)
        return url

    async def __stream(self, endpoint, listener, params={}, run_async=False, timeout=__DEFAULT_STREAM_TIMEOUT,
                       reconnect_async=False, reconnect_async_wait_sec=__DEFAULT_STREAM_RECONNECT_WAIT_SEC):
        """
        Internal streaming API helper.
        ...
        url = await self.__get_streaming_base()
        ...
        def connect_func():
            ...
            if connection.status_code != 200:
                print("Mark this one as bad imo ")
        ...
        if run_async:
            try:
                headers = {"Authorization": "Bearer " + self.access_token} if self.access_token else {}
                async with self.session.stream('GET', url + endpoint, headers=headers, data=params,
                                               timeout=(self.request_timeout, timeout)) as r:
                    await listener.handle_stream(r)
            except Exception as e:
                print(repr(e))
                raise
